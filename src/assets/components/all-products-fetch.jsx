            ...
            <div className="flex flex-wrap justify-center items-center gap-6 w-full h-max">
                {
                    products.map((product)=>{
                        return (
                            <>
                                <div className="flex flex-col gap-2 justify-between items-center w-52 hover:shadow-[0_0_0_2px_#D10024] py-2 px-4 shadow-[0_0_0_1px_#E4E7ED] h-[450px] text-center cursor-pointer duration-100  ">
